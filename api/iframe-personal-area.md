...
Поля запроса:
Имя параметра	Тип данных	Описание	Обязат.
uuid	См. описание команды charge.	Да
Поля ответа:
Имя параметра	Тип данных	Описание	Обязат.
uuid	См. описание полей запроса команды.	Да
...
isJuridical	Число 0 или 1	Признак того, что пользователь является юридическим лицом (корпоративным клиентом). По умолчанию «0».	Нет
...
6.4 Команда notifyStatusChange
Поля запроса:
Имя параметра	Тип данных	Описание	Обязат.
uuid	См. описание команды charge.	Да
txid	См. описание команды charge.	Да
serviceKey	См. описание команды charge.	Да
serviceName	См. описание команды charge.	Да
subId	См. описание команды charge.	Да
comment	См. описание команды charge.	Да
computerName	См. описание команды charge.	Да
status	Новый статус подписки.	Да
Поля ответа:
Имя параметра	Тип данных	Описание	Обязат.
txid	См. описание полей запроса команды.	Да
6.5 Команда getUuidsByTariff
Поля запроса:
Имя параметра	Тип данных	Описание	Обязат.
...
Поля ответа:
Имя параметра	Тип данных	Описание	Обязат.
tariffId	См. описание полей запроса команды.	Да
...
Поля ответа:
Имя параметра	Тип данных	Описание	Обязат.
query	См. описание полей запроса команды.	Да
uuid	См. описание команды charge.	Да
name	Строка	ФИО или название юр. лица пользователя на стороне оператора.	Нет
login	Строка	Логин пользователя на стороне оператора.	Нет
email	E-mail	Адрес электронной почты пользователя на стороне оператора.	Нет
